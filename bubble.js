...
"#EEE4E1","#E7D8C9","#E6BEAE","#B9B0CF","#e8f0ff","#e8f0f0","#ADB6E7","#3DDBA0","#DBA949","#CEB4DB"])
 //var color = d3.scaleOrdinal(d3.schemeCategory20c)
  ...
  node.append("text")
    ...
    .selectAll("tspan")
    .data(function(d) { return d.short ? d.short.split(/(?=[A-Z][^A-Z])/g); })
    .enter()
    .append("tspan")
